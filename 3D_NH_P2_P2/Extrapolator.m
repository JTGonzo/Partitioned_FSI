    ...
    methods
        ...
        function [xe] = predict(E)
            ...
            switch E.n                
                ...
                case E.n1
                    xe = E.x;                            %| first time step prediction                     
                 otherwise
%                 case E.n2
                    xe = 2.0*E.x - E.xn;                  %| second time step prediction                  
%                 otherwise
%                     xe = 3.0*E.x - 3.0*E.xn + 1.0*E.x2n;  %| all subsequent time step predictions
%                     %xe = 2.5*E.x - 2.0*E.xn + 0.5*E.x2n;
        ...
        function add(E,x)            
            E.xp = x;                     % adding new time step information to the predictor matrix       
        end
 
 %% Dynamically maintaining the data used for extrapolation
        function initialize(E,x)    % initializing the vector size
            E.xp  = x;
            E.x   = x;
            E.xn  = x;
            E.x2n = x;
        ...
        function shift(E)           % shifting what we define to the previous 3 time-step data values            
            E.x2n = E.xn;         
            E.xn  = E.x;
            E.x   = E.xp;
        end
