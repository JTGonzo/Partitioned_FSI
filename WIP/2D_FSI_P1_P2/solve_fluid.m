function [uF, C_NS, F_NS, trac] =  solve_fluid(MESH, DATA, FE_SPACE_v, FE_SPACE_p, TimeAdvanceF, TimeAdvanceS, t, dt, ALE_velocity, uS)
...
%%  construct the NS algebraic formulation and apply boundary conditions
    ...
    [C_NS_in, F_NS_in, v_D, v_gamma] =  CFD_ApplyBC(C_NS, F_NS, FE_SPACE_v, FE_SPACE_p, MESH, DATA.Fluid, t, TimeAdvanceS, uS);
